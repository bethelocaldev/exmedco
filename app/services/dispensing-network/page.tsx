      ...
      <main>
        ...
        <section className="py-20 bg-secondary text-secondary-foreground">
          <div className="container mx-auto px-4 text-center">
            <h2 className="font-serif text-3xl md:text-4xl font-bold mb-4">Expand Your Dispensing Reach</h2>
            <p className="text-secondary-foreground/70 text-lg max-w-xl mx-auto mb-8">
              Partner with FHY Gloexpo to place your products in trusted pharmacy environments across APAC.
            </p>
